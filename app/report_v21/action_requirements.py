...
RULE_REMEDIATION_GUIDANCE: dict[int, str] = {
    ...
    26: "Resolve the confirmed core-brand conflict between the page and checked GBP record.",
    27: "Resolve the confirmed physical-location conflict between the page and checked GBP record.",
    28: "Publish at least one valid business phone number that also appears on the checked GBP record.",
    29: "Resolve the confirmed service-area conflict between the page and checked GBP record.",
...
ACTION_REQUIREMENTS: tuple[ActionRequirement, ...] = (
    ...
    ActionRequirement(
        ...
        "high",
        "small",
        "Resolve the confirmed core-brand conflict with the checked business record.",
    ),
    ActionRequirement(
        ...
        "high",
        "medium",
        "Resolve the confirmed physical-location conflict with the checked business record.",
    ),
    ActionRequirement(
        ...
        "high",
        "small",
        "Add or retain at least one valid business phone number shared with the checked business record.",
    ),
    ActionRequirement(
        ...
        "high",
        "medium",
        "Resolve the confirmed service-area conflict with the checked business record.",
    ),
    ActionRequirement(
